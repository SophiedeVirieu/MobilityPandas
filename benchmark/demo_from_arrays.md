...
|---------------|-------------|
| ![alt text](diagrams/from_arrays_t_big.png) | ![alt text](diagrams/from_arrays_m_big.png) |

### Medium dataset (1 million rows)

| Execution time | Memory usage |
|---------------|-------------|
|  ![alt text](diagrams/from_arrays_t_med.png)  |  ![alt text](diagrams/from_arrays_m_med.png)  |

### Small dataset (100 thousands rows)

| Execution time | Memory usage |
|---------------|-------------|
|  ![alt text](diagrams/from_arrays_t_small.png)  |  ![alt text](diagrams/from_arrays_m_small.png)  |
